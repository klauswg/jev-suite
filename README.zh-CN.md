...
| jev-fidelity | 编辑是否保留了原文的信息？ | ✅ v0.1.0 — 55 样本/110 事实校准：门控判定 91/92 正确，17 个按设计弃权，注入 0/20 翻转 |
| jev-rental | 看房前必须向中介确认哪些事项？ | ✅ v0.1.0 — 50 样本/178 声明校准：门控 0.910 对裸判定 0.854，注入 0/10 翻转 |
